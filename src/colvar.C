...
#define initialize_components(def_desc,def_config_key,def_class_name)   \
  ...
  initialize_components ("dipole magnitude",     "dipoleM",   dipole_magnitude);
                         ...
                         colvarvalue const &x2) const
{
  ...
  std::cout<<"dist2 "<<(cvcs[0])->dist2 (x1, x2) <<std::endl;
  */
...
{
  /*
  std::cout<<"=========dist2_lgrad========"<<std::endl;
  std::cout<<"x1="<<x1<<" x2="<<x2<<std::endl;
  std::cout<<"dist2_lgrad_out "<<(cvcs[0])->dist2_lgrad (x1, x2) <<std::endl;
  std::cout<<"cvcs[0]"<<cvcs[0] <<std::endl;
  std::cout<<"=========end dist2_lgrad========"<<std::endl;
  */
